...
ifndef TEMPESTTOOLSDIR
  $(error TEMPESTTOOLSDIR is not defined)
endif

# Add the source directories to the include path
CXXFLAGS+= -I$(TEMPESTTOOLSDIR)/src/base

ifeq ($(NETCDF),TRUE)
  CXXFLAGS+= -I$(TEMPESTTOOLSDIR)/src/netcdf-cxx-4.2
  LDFLAGS+= -L$(TEMPESTTOOLSDIR)/src/netcdf-cxx-4.2
endif
